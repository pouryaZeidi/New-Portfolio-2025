...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-24 flex items-center justify-between px-6 z-50">
      ...
      <div className="hidden sm:flex w-[70%] p-4 bg-black bg-opacity-70 border-white border-[1px] backdrop-blur-2xl shadow-lg rounded-2xl items-center justify-between m-auto">
